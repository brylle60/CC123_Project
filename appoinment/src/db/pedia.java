...
public class pedia {
    public static boolean register(String last_name, String first_name, String middle_name,String gender, int age, long number,String address){
        try{
            ...
            PreparedStatement insertUser = connection.prepareStatement("INSERT INTO " + commonconstant.PEDIA + "( last_name,first_name, middle_name, sex, age, number, address)" + "VALUES(?, ?, ?, ?, ?, ?, ?)");
