...
public class OphthalmologyDescription extends DescriptionPage {

    public OphthalmologyDescription() {
        super("MedCare (Ophtalmology Description)");
        GuestPageExtends();
    ...
    private void GuestPageExtends() {
        ...
        JLabel description = new JLabel("Our Ophthalmology services specialize in the diagnosis, treatment, ");
        ...
        JLabel description1 = new JLabel("and management of eye-related conditions and disorders, ensuring ");
        ...
        JLabel description2 = new JLabel("optimal vision and eye health for patients of all ages.");
        ...
        JLabel description4 = new JLabel("•Comprehensive eye examinations");
        ...
        JLabel description5 = new JLabel("•Prescription of corrective lenses (glasses or contact lenses)");
        ...
        JLabel description6 = new JLabel("•Treatment of common eye problems such as dry eyes and conjunctivitis");
        ...
        JLabel description7 = new JLabel("•Management of chronic conditions like glaucoma and diabetic retinopathy");
        ...
        JLabel description8 = new JLabel("•Surgical procedures such as cataract surgery and LASIK");
        ...
        JLabel description9 = new JLabel("•Screening and management of eye diseases related to systemic conditions");
        ...
        accountButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                OphthalmologyDescription.this.dispose();
        ...
        //service image
        ImageIcon ob = new ImageIcon("appoinment/src/image/op1.png");
        ...
        //OG label
        JLabel ObygynLabel = new JLabel("Ophthalmology");
        ObygynLabel.setBounds(412, 454, 280, 50);
        ObygynLabel.setForeground(commonconstant.SECONDARY_COLOR);
        ObygynLabel.setFont(new Font("Georgia",Font.BOLD, 18));
        add(ObygynLabel);

        JLabel OGdoc = new JLabel("- Dr. Khen Lloyd Baylon");
        ...
        ImageIcon image6 = new ImageIcon("appoinment/src/image/khen.png");
