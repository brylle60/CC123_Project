...
<<<<<<<< HEAD:appoinment/src/doctors/FillUpPediatrics.java
public class FillUpPediatrics extends doctors{
========
public class Pedia extends doctors{
>>>>>>>> upstream/main:appoinment/src/doctors/Pedia.java
...
>>>>>>>> upstream/main:appoinment/src/doctors/Pedia.java
    ...
    private void addDoctorComponents() {
        ...
        ImageIcon patientIcon = new ImageIcon("appoinment/src/image/DR FAITH.png");
        JLabel patientLabel = new JLabel(patientIcon);
        patientLabel.setBounds(105, 154, 170, 170); // Adjust the position and size as needed

        JLabel doctorn3= new JLabel("Dr. Chelsie Faith Maranga");
        ...
        JLabel servicen3= new JLabel("PEDIATRICS");
        ...
        submit.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (last_name.isEmpty() || first_name.isEmpty() || middle_name.isEmpty() || ageString.isEmpty() || sex.isEmpty() || address.isEmpty() || numberString.isEmpty()) {
                    JOptionPane.showMessageDialog(Pedia.this, "Please fill in all the required fields.", "Invalid Input", JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(Pedia.this, "Invalid age. Please enter a valid number.", "Invalid Input", JOptionPane.ERROR_MESSAGE);
                    return; // Exit the method without proceeding further
                }
                ...
                if (validateUser(last_name, first_name, middle_name, sex, age, number, address)) {
                    ...
                    JOptionPane.showMessageDialog(Pedia.this, " Incorrect Input");
                }
            }
        });
